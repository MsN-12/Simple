...
// Source: github.com/MsN-12/simpleBank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateUserTx(arg0 context.Context, arg1 db.CreateUserTxParams) (db.CreateUserResult, error) {
	m.ctrl.T.Helper()
